...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        # opponent.deck.cards = [card in opponent.deck.cards if card.attack == other_card.attack or card.defense == other_card.defense]
